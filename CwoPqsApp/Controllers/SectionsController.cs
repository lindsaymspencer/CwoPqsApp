...
namespace CwoPqsApp.Controllers
{
    public class SectionsController : Controller
    {
        ...
        public SectionsController(CwoPqsAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Number")] Section section)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Number")] Section section)
        {
            if (id != section.Id)
            {
                return NotFound();
